...
Keep internal identifiers, audit fields, locking fields, and timestamps guarded. Public APIs expose ULIDs and enum values, not internal IDs or enum objects.
